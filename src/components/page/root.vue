<template>
    <good-page>
        ...
        <good-menu>
            <good-button class='float-right' icon="el-icon-edit" type="primary" v-if="state.permission.root_add"  @click="openColumn(2,'新增栏目')">新增栏目</good-button>
                ...
                <table class="table-group">
                    ...
                    <template v-for="(item,index) in viewList">
                        <tr v-if="item.type==2" style="height:45px;">
                            <td>
                                <span class="pointer keys" @click="select(item,'编辑标签')" v-if="state.permission.root_edit">{{index+1}}、{{item.name}}</span>
                            ...
                            <td>
                               ...
                               <el-button class="button-new-tag" size="small" v-if="state.permission.root_edit"  @click="openColumn2(item)">+ 新增</el-button>
                                </div>
