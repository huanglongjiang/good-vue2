...
var target_popover={
	...
	loading:function(title){		
		var html=`<div class="loading zoomIn animated01" style="z-index: 111; width:250px; margin-left:-125px;">
				<div class="i font-size-45 fa fa-spinner"></div>
				<div class="text font-size-18">${title}</div>
				</div>${this.backdrop2()}`;
	...
	success:function(title){
		...
		var html=`<div id="success" class="popover-success zoomIn animated01" data-modal="zx" style="z-index: 111;">
				  	<div class="popover-success-top">
						<div class="popover-success-ico"></div>
						<div class="popover-success-title1">操作成功</div>
						<div class="popover-success-title2 font-size-18">${title}</div>
					</div>
					<div class="popover-success-bottom">
						<div class="button button-primary button-sm" data-close="modal">关闭</div>
					</div>
				</div>${this.backdrop()}`;			
			return $("body").append(html);
	},
