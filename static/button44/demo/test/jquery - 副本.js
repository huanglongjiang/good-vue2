...
$(function(){
	...
	$(document).on("click","[data-close='modal-animate']",function(){
		...
		$("div").remove(".panel-backdrop");
		$(this).parents("[data-modal='zx']").animate({"right":"-1000px"},300);

	})


	$(document).on("click","[data-popover='modal-animate-bottom']",function(){
		// $("div").remove(".panel-backdrop");
		// var backdrop='<div class="panel-backdrop"></div>'
		// $("body").append(backdrop);
		var i=$(this).attr("data-target");
		console.log(i)
		$(i).animate({"bottom":"0px"},500);

	})

	$(document).on("click","[data-close='modal-animate-bottom']",function(){

		//$("div").remove(".panel-backdrop");
		$(this).parents("[data-modal='zx']").animate({"bottom":"-500px"},500);
