...
var requirejs, require, define; (function(ca) {
		...
		$.prototype = {
			...
			enable: function() {
				...
				function(a, b) {
					...
					c = a.id;
					f = k[c]; ! s(K, c) && (f && !f.enabled) && i.enable(a, this)
				}));
	...
	if ("undefined" === typeof define) {
		...
		function(b) {
			y || (y = b.parentNode);
			if (L = b.getAttribute("data-main")) return q = L,
		...
		define = function(b, c, d) {
			...
			if (O) {
				if (! (g = M)) P && "interactive" === P.readyState || U(document.getElementsByTagName("script"),
				function(b) {
